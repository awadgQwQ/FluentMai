...
public abstract class Tunnel {
    ...
    public void onConnectable() {
        try {
            if (m_InnerChannel.finishConnect()) {
                ...
                Log.w("VpnProxy", "Tunnel connect did not finish: " + m_ServerEP);
                this.dispose();
            }
        } catch (Exception e) {
            Log.w("VpnProxy", "Tunnel connect failed: " + m_ServerEP, e);
            this.dispose();
        }
    }
    ...
    public void onReadable(SelectionKey key) {
        try {
            ...
            Log.w("VpnProxy", "Tunnel read failed: " + m_DestAddress, e);
            this.dispose();
        }
    }
    ...
    public void onWritable(SelectionKey key) {
        try {
            ...
            Log.w("VpnProxy", "Tunnel write failed: " + m_DestAddress, e);
            this.dispose();
        }
    }
